    ...
    <form class="form-horizontal" action="process_new_user.php" method="get">
        <fieldset>
            ...
            <div class="form-group"> <label class="col-md-4 control-label" for="keyword">New password</label>
                <div class="col-md-5"> <input id="password" type="password" name="password" placeholder="" class="form-control input-md" required="">
            ...
            <div class="form-group"> <label class="col-md-4 control-label" for="keyword">Confirm password</label>
                <div class="col-md-5"> <input id="password-confirm" type="password" name="password-confirm" placeholder="" class="form-control input-md" required="">
